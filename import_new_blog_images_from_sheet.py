...
# LOAD EXCEL
# --------------------------
file_path = "Master News articles Jan5.xlsx"
sheet_name = "Articles from VP"

df = pd.read_excel(file_path, sheet_name=sheet_name)

# --------------------------
# FILTER BY _source_file
# --------------------------
df = df[df['_source_file'] == 'boldfact-blogs-Jan2.json']
...
print(f"Processed {len(data)} records from boldfact-blogs-Jan2.json successfully.")
